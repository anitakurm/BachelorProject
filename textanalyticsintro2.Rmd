...
write.csv(train.tokens.df, file = "traintokensdf.csv")
...
train.tokens <- tokens_ngrams(train.tokens, n = 2) #unigrams and bigrams 1:5 <- uni, bi, tri, qudro, fivegrams
#write n=2 if you want just bigrams
train.tokens[[357]]
...
set.seed(48743)
cv.folds <- createMultiFolds(train$Label, k = 5, times = 2)
...
Cosine similarity over the dot product!
```{r}
